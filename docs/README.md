...
| **[poc/README.md](poc/README.md)** | The bare-bones POC: one Function App, one Event Hub, one Storage Account. No Redis, no Cribl, no Torq. Complete setup guide, ~45 minutes to a working demo. | You're standing up the POC in the company Azure, or demoing it. |
